...
export default function LinkedInDatenleck() {
  const facts = [
    { number: "700", unit: "Millionen", label: "Betroffene Nutzer" },
    { number: "2022", unit: "", label: "Jahr des Leaks" },
    { number: "90%", unit: "", label: "Daten echt" },
  ...
  const leakedData = [
    ...
    { label: "Physische Adresse", included: true },
    { label: "Berufserfahrung", included: true },
    { label: "LinkedIn Profile URL", included: true },
    { label: "Soziale Konten", included: true }
  ];
