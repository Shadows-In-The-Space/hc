...
export default function Rotlichtverstoss() {
  ...
  const penalties = [
    { case: "bis 1 Sekunde", fine: "90 €", points: "1", ban: "-" },
    { case: "über 1 Sekunde", fine: "200 €", points: "2", ban: "1 Monat" },
    { case: "mit Unfall", fine: "360 €", points: "2", ban: "1 Monat" },
  ];
              ...
              <ScrollReveal key={i} direction="left" delay={i * 0.1} className="w-full">
                <AnimatedCard className="flex items-center gap-3 p-6 bg-slate-50 rounded-2xl hover:bg-red-50 transition-colors">
                  <div className="w-10 h-10 bg-red-100 rounded-xl flex items-center justify-center shrink-0">
                    <TrafficCone className="text-red-500" size={20} />
                  </div>
      ...
      <section className="py-24 px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            ...
            <p className="text-slate-600">Bußgeldkatalog für Rotlichtverstöße:</p>
          </motion.div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {penalties.map((pen, i) => (
                  ...
                  >
                    <td className="p-4 text-slate-700">{pen.case}</td>
